...
**Raicom2024** 是由本人参加 **2024 RAICOM机器人开发者大赛“平安城市”赛项** 时开发的视觉算法

本项目主要面向**第一次参加该赛题的同学（尤其是缺少比赛经验的大一新生）**。仓库系统性地整理了2024年省赛（P1、P2、P3）三个核心视觉任务的算法实现，旨在帮助新手快速了解赛题难度、任务形式以及主流的解题思路，为后续的算法优化和国赛冲刺打下坚实基础。
...
- **核心文件**：`src/p3_building_fire.py` *(注：P3 代码文件丢失，当前版本为基础功能实现，欢迎补充完善)*
